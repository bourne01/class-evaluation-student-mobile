    ...
    <div>
        ...
        <div class="popup-wrap" v-if="isPopup">
            <div class="detail-popup" >
                <header>
                    <span>{{removeStrDuplicate(myClass.courseName)}}</span>
                    <img :src="require('../../assets/schedule/close.png')" alt="" @click="isPopup=false">
                </header>
                <div class="class-detail">
                    <div class="class-name">
                        <label for="">
                            <img :src="require('../../assets/schedule/classmate.png')" alt="">
                            <span>班级</span>
                        </label>
                    ...
                    <div class="classroom">
                            <label for="">
                                <img :src="require('../../assets/schedule/classroom.png')" alt="">
                                <span>教室</span>
                            </label>
                    ...
                    <div class="current-week">
                            <label for="">
                                <img :src="require('../../assets/schedule/week.png')" alt="">
                                <span>周数</span>
                            </label>
                    ...
                    <div class="class-sequence">
                            <label for="">
                                <img :src="require('../../assets/schedule/class-sequence.png')" alt="">
                                <span>节数</span>
                             </label>
                    ...
                    <div class="teacher">
                            <label for="">
                                <img :src="require('../../assets/schedule/teacher.png')" alt="">
                                <span>教师</span>
                            </label>
...
export default {
    ...
    methods:{
        ...
        */
        ...
        /**
         *@function 字符串转数组，且数组去重，最后变成转化为字符串 
         *@param {字符串} str
         */ 
        removeStrDuplicate(str){
            let arr = str.split(',');
            arr = arr.filter(function(element,index,self){return self.indexOf(element) === index;});
            return arr.toString()
        },
    },
    ...
    created(){        
        ...
        for(let i=this.row;i<classTableLen;i++){
            ...
            if(_curClass.courseName == courseName && _curClass.className == _className &&
        ...
        if(this.column == 0){
            ...
            this.classInfo ="<span>"+this.mySubString(this.removeStrDuplicate(this.myClass.courseName))+"</span>"; 
        }
